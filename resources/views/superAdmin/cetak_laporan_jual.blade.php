...
$query = "SELECT * FROM table_laporan_jual WHERE tanggal_jual BETWEEN '$tglAwal' AND '$tglAkhir'";
$result = mysqli_query($conn, $query);

// Header untuk membuat file PDF
header('Content-Type: application/pdf');
header('Content-Disposition: inline; filename="laporan_jual.pdf"');
...
$pdf->SetTitle('Laporan Transaksi Penjualan');
$pdf->SetHeaderData('', '', 'Laporan Transaksi Penjualan', '');
