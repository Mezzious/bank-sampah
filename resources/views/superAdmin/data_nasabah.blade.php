        ...
        <div class="page-heading">
            <div class="row">
                <div class="d-flex align-items-center justify-content-between ">
                    <h2 class="h2 mb-0 col-4 col-md-2 text-gray-800">Data Nasabah</h2>
                                ...
                                @foreach ($cust as $customer)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{ route('edit_nasabah', ['id' => $customer->id]) }}"
                                            ...
                                            <form id="delete-form-{{ $customer->user_id }}"
                                                action="{{ route('destroy_nasabah', $customer->user_id) }}"
