                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ route('transaksi_jual_admin') }}" class="submenu-link"> Transaksi Beli</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="{{ route('transaksi_beli_admin') }}" class="submenu-link"> Transaksi Jual</a>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ route('laporan_jual_admin') }}" class="submenu-link">Laporan Beli</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="{{ route('laporan_beli_admin') }}" class="submenu-link">Laporan Jual</a>
